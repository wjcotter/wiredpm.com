	...
	public function admin() {
		...
		<div class="changelog">
			...
			<div class="feature-section">
				...
				<p><?php _e( 'You may notice that the default Genesis stylesheet is a bit shorter, and on the front end looks different. We\'ve updated the default design and extended the width of the layout to 1152px. Now you\'ve got more real estate to showcase your content.', 'genesis' ); ?></p>
		...
		<div class="contributers">
			...
			<li class="wp-person" id="wp-person-travis">
				<a href="http://twitter.com/wpsmith"><img src="http://0.gravatar.com/avatar/7e673cdf99e6d7448f3cbaf1424c999c?s=60" class="gravatar" alt="Travis Smith" /></a>
				<a class="web" href="http://twitter.com/wpsmith">Travis Smith</a>
				<span class="title"><?php _e( 'Contributor', 'genesis' ); ?></span>
			</li>
			</ul>
